...
- [ ] Strengthen biomes into full material/style sets (Void Station / Alien Nexus)
- [ ] Add architectural details in builder (ribs / beams / door frames / borders / corner pillars)
- [ ] Add floor patterns / panels / center motifs
- [ ] Add rule-based decorative props by room zones
- [ ] Add atmosphere pass (fog / emissive accents / background silhouettes / grading)
